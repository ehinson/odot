...
describe UserSessionsController do
  ...
  describe "POST 'create'" do
    context "with correct credentials" do
      let!(:user) { User.create(first_name: "Erin", last_name: "Hinson", email: "erin@email.com", password: "treehouse1", password_confirmation: "treehouse1") }

      it "redirects to the todo list path" do
        post :create, email: "erin@email.com", password: "treehouse1"
